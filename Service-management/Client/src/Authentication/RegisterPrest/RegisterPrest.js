...
export default function Register_prest() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:4000/authPrest/register', formData);
                ...
                <div className="card">
                  <div className="card-body py-5 px-md-5">
                    ...
                    <h6>
                      ...
                      <Link to="/LoginPrest" style={{ textDecoration: "none" }}>
                        {" "}
                        Log in
                      </Link>
                    </h6>
